...
public class FeaturedVerAdapter extends RecyclerView.Adapter<FeaturedVerAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.detailed_img1);
            name = itemView.findViewById(R.id.detailed_name1);
            description = itemView.findViewById(R.id.detailed_des1);
            rating = itemView.findViewById(R.id.detailed_rating1);
            timing = itemView.findViewById(R.id.detailed_timing1);
        }
    }
}
